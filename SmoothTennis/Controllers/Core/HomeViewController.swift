...
//        let button = UIBarButtonItem(title: "Why no text", style: .bordered, target: self, action: #selector(goPurchase))
//        button.tintColor = .systemGreen
//        button.image = UIImage(systemName: "circle.circle")
//        return button
//    }()
    ...
    override func viewDidLoad() {
        ...
        fetchPosts()
        //make the pointButton the navigation bar leftside
        //view.addSubview(pointButton)
        //pointButton.addTarget(self, action: #selector(goPurchase), for: .touchUpInside)
...
//
//        }
//        DatabaseManager.shared.getIndividualPoints(for: UserDefaults.standard.string(forKey: "username")!) { success in
//            guard success else {
//                return
//            }
//        }
...
//        let vc = PlayerViewController(videoName: "testVideo", url: URL(string: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4")!)
...
//        DatabaseManager.shared.getPointsAmount(for: username) { amount in
            //self.pointButton.setTitle("\(Int(amount))", for: .normal)
//            self.navigationItem.rightBarButtonItem = self.button
//            self.navigationItem.rightBarButtonItem?.title = ("\(Int(amount))")
//            self.navigationItem.rightBarButtonItem?.tintColor = .systemGreen
//            self.navigationItem.rightBarButtonItem?.image = UIImage(systemName: "circle.circle")
...
//        navigationController?.pushViewController(vc, animated: true)
    ...
    private func createViewModel(
        ...
        StorageManager.shared.profilePictureURL(for: username) { [weak self] profilePictureURL in
            //might have to add a videoURL variable
