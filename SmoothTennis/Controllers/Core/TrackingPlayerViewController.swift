//
//  TrackingPlayerViewController.swift
//  SmoothTennis
//
...
class TrackingPlayerViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
...
//    private let owner: String
    ...
    private var viewModelsV2: [TrackingPlayerCommentCellType] = []
    ...
    private let noTransactionsYet: UILabel = {
        let myLabel = UILabel()
        myLabel.numberOfLines = 0
        myLabel.text = "You have no posts to track!"
...
//        }
    ...
    private func createViewModel(
        ...
        DatabaseManager.shared.getPlayerComment(commenter: targetUsername) { eachData in
            var postData: [TrackingPlayerCommentCellType] = []
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .comment(let viewModel):
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: PlayerTrackCollectionViewCell.identifier, for: indexPath)
            as? PlayerTrackCollectionViewCell else {
                fatalError()
            }
...
extension TrackingPlayerViewController: PlayerTrackCollectionViewCellDelegate {
...
extension TrackingPlayerViewController {
...
//                                forCellWithReuseIdentifier: TrackingCoac.identifier)

        collectionView.register(PlayerTrackCollectionViewCell.self, forCellWithReuseIdentifier: PlayerTrackCollectionViewCell.identifier)
