...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private func configureModels() {
        sections.append(
            SettingsSection(title: "Learn More", options: [
                SettingOption(
                    title: "Learn More",
                    image: UIImage(systemName: "star"),
                    color: .systemOrange
                ) {
                    guard let url = URL(string: "https://www.appjourneyjeffrey.com") else {
                        return
                    }
...
//                    color: .systemBlue
//                ) { [weak self] in
//                    guard let url = URL(string: "https://apps.apple.com/us/app/SmoothTennis/id389801252") else {
//                        return
//                    }
//                    DispatchQueue.main.async {
...
//                    color: .systemPurple
//                ) { [weak self] in
//                    guard let url = URL(string: "https://help.SmoothTennis.com/") else {
//                        return
//                    }
//                    let vc = SFSafariViewController(url: url)
//                    self?.present(vc, animated: true, completion: nil)
